...
$opt_name = 'build_opt';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args['admin_bar_links'][] = array(
	'id'    => 'build-docs',
	'href'  => '#',
	'title' => __( 'Documentation', 'build' ),
);

$args['admin_bar_links'][] = array(
	'href'  => '#',
	'title' => __( 'Support', 'build' ),
);
...
$args['share_icons'][] = array(
	'url'   => '//github.com/AlinaHarakh',
	'title' => 'Visit us on GitHub',
	'icon'  => 'el el-github',
);
$args['share_icons'][] = array(
	'url'   => '//www.facebook.com/Alina_Harakh',
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header Settings', 'build' ),
		'id'               => 'basic',
		'desc'             => esc_html__( 'Data to be displayed in header', 'build' ),
		...
		Redux::set_section(
			$opt_name,
			array(
				'title'            => esc_html__( 'Logo Section', 'build' ),
				'desc'             => __( 'Specify the header info.', 'build' ),
				'id'               => 'site_logo',
				...
				'fields'           => array(
					array(
						'id'       => 'build_logo',
						'type'     => 'text',
						'title'    => esc_html__( 'Logo', 'build' ),
						'subtitle' => esc_html__( 'Type a logo for a website', 'build' ),
						'desc'     => esc_html__( 'Your Logo', 'build' ),
						'default'  => '',
					),
		...
		Redux::set_section(
			$opt_name,
			array(
				'title'            => esc_html__( 'Секція промо', 'build' ),
				'desc'             => __( 'Введіть данні для головної секції.', 'build' ),
				'id'               => 'site_utp',
				'customizer_width' => '700px',
				'fields'           => array(
					array(
						'id'       => 'utp-title',
						'type'     => 'text',
						'title'    => esc_html__( 'Заголовок', 'build' ),
						'subtitle' => esc_html__( 'Вкажіть заголовок', 'build' ),
						'desc'     => esc_html__( 'Головний заголовок', 'build' ),
						'default'  => '',
					),
					array(
						'id'       => 'utp-text',
						'type'     => 'editor',
						'title'    => esc_html__( 'Текст', 'build' ),
						'subtitle' => esc_html__( 'Введіть текст', 'build' ),
						'desc'     => esc_html__( 'Текст', 'build' ),
						'default'  => '',
					),
					array(
						'id'       => 'utp-button',
						'type'     => 'text',
						'title'    => esc_html__( 'Текст кнопки', 'build' ),
						'subtitle' => esc_html__( 'Введіть текст для кнопки', 'build' ),
						'desc'     => esc_html__( 'Текст кнопки', 'build' ),
						'default'  => '',
					),
		...
		Redux::set_section(
			$opt_name,
			array(
				'title'     			 => esc_html__( 'Social Links', 'build' ),
				'desc'       			 => esc_html__( 'Type here social links', 'build' ) ,
				'id'               => 'social_links',
				'customizer_width' => '700px',
				'subsection'			 => true,
				'fields'     			 => array(
					array(
						'id'              => 'fb',
						'type'            => 'text',
						'title'           => esc_html__( 'Facebook Link', 'build' ),
						'subtitle'        => esc_html__('Type here your link', 'build' ),
						'desc'       		  => esc_html__( 'Your Profile Link', 'build' ),
						'default' 			  => '',
					),
					array(
						'id'              => 'inst',
						'type'            => 'text',
						'title'           => esc_html__( 'Instagram Link', 'build' ),
						'subtitle'        => esc_html__( 'Type here your link', 'build' ),
						'desc'        		=> esc_html__( 'Your Profile Link', 'build' ),
						'default'  				=> '',
					),
					array(
						'id'              => 'teleg',
						'type'            => 'text',
						'title'           => esc_html__( 'Telegram Link', 'build' ),
						'subtitle'        => esc_html__( 'Type here your link', 'build' ),
						'desc'        		=> esc_html__( 'Your Profile Link', 'build' ),
						'default' 				=> '',
					),
		...
		Redux::set_section(
			$opt_name,
			array(
				'title'     			 => esc_html__( 'Archive Header Settings', 'build' ),
				'desc'       			 => esc_html__( 'Вкажіть інформацію для шапки архівної сторінки проектів', 'build' ) ,
				'id'               => 'archive_settings',
				'customizer_width' => '700px',
				'subsection'			 => true,
				'fields'     			 => array(
					array(
						...
						'title'           => esc_html__( 'Заголовок', 'build' ),
						'subtitle'        => esc_html__('Вкажіть заголовок', 'build' ),
						'desc'       		  => esc_html__( 'Заголовок сторінки з проектами', 'build' ),
						'default' 			  => '',
					),
					array(
						'id'       => 'houses_count',
						'type'     => 'text',
						'title'    => esc_html__( 'Постів на сторінці', 'build' ),
						'subtitle' => esc_html__( 'Кількість постів', 'build' ),
						'desc'     => esc_html__( 'Кількість постів на сторінці з усіма постами', 'build' ),
						'default'  => '6',
						'validate' => 'numeric',
					),
				),
...
Redux::set_section(
	$opt_name,
		array(
				'title'            => esc_html__( 'Footer Settings', 'build' ),
				'id'               => 'basic',
				'desc'             => esc_html__( 'Data to be displayed in footer', 'build' ),
				'customizer_width' => '400px',
				'icon'             => 'el el-home',
			)
		);
		...
		Redux::set_section(
			$opt_name,
			array(
				'title'      				=> esc_html__( 'Налаштування підвалу сайту', 'build' ),
				'desc'       				=> esc_html__( 'Type here info for footer', 'build' ) ,
				'id'              	=> 'footer_data',
				'customizer_width' 	=> '700px',
				'subsection'			 	=> true,
				'fields'     				=> array(
					array(
						'id'              => 'copyrights',
						'type'            => 'editor',
						'title'           => esc_html__( 'Копірайт', 'build' ),
						'subtitle'        => esc_html__( 'Напишіть копірайт', 'build' ),
						'default' 				=> '2022 Всі права захищені',
					),	
					array(
						'id'              => 'phone1',
						'type'            => 'text',
						'title'           => esc_html__( 'Номер телефону 1', 'build' ),
						'subtitle'        => esc_html__( 'Напишіть номер телефону 1', 'build' ),
						'default' 				=> '',
					),
					array(
						'id'              => 'phone2',
						'type'            => 'text',
						'title'           => esc_html__( 'Номер телефону 2', 'build' ),
						'subtitle'        => esc_html__( 'Напишіть номер телефону 2', 'build' ),
						'default' 				=> '',
					),					
				),
			)
